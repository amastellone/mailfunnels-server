...
RSpec.describe BatchEmailJobsController, type: :controller do
  ...
  # BatchEmailJobsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new batch_email_job" do

        post :create, params: {batch_email_job: invalid_attributes}, session: valid_session
