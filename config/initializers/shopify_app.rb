ShopifyApp.configure do |config|
  ...
  config.webhooks = [
    ...
    # {topic: 'refunds/create', address: 'https://cc8c8c32.ngrok.io/webhooks/refunds_create', format: 'json'},
    # {topic: 'orders/create', address: 'https://cc8c8c32.ngrok.io/webhooks/orders_create', format: 'json'},
    # {topic: 'carts/update', address: 'https://cc8c8c32.ngrok.io/webhooks/carts_update', format: 'json'},
  ]
end
