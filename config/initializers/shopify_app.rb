ShopifyApp.configure do |config|
  ...
  config.webhooks = [
    ...
    # {topic: 'refunds/create', address: 'https://870f79c4.ngrok.io/webhooks/refunds_create', format: 'json'},
    # {topic: 'orders/create', address: 'https://870f79c4.ngrok.io/webhooks/orders_create', format: 'json'},
    # {topic: 'checkouts/create', address: 'https://870f79c4.ngrok.io/abandoned_cart_process', format: 'json'},
  ]
end